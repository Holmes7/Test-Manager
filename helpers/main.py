...
class Program:
    ...
    def __init__(self, filename, inputfile, outputfile, timelimit, expectedoutputfile):
        ...
        self.actualOutputFile = outputfile  # Actual output file
    ...
    def compile(self):
        ...
        if self.language == 'java':
            ...
            cmd = 'g++-11 -o {0} {1}'.format(self.name, self.fileName)
            print(self.fileName)
            # cmd = 'g++-11 -o {0}'.format(self.fileName)
...
def codechecker(filename, inputfile=None, outputfile=None, expectedoutput=None, timeout=1, check=True):
    newprogram = Program(
        filename=filename,
        inputfile=inputfile,
...
if __name__ == '__main__':
    ...
    codechecker(
        filename='A.cpp',               # Source code file
